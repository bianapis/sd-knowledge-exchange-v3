...
/**
 * BQCaptureandClassificationExchangeInputModel
 */
public class BQCaptureandClassificationExchangeInputModel   {
  ...
  private CRIntellectualPropertyExchangeOperatingSessionExchangeInputModelIntellectualPropertyExchangeOperatingSessionExchangeActionRequest captureandClassificationExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get captureandClassificationExchangeActionRequest
   * @return captureandClassificationExchangeActionRequest
  **/

  public CRIntellectualPropertyExchangeOperatingSessionExchangeInputModelIntellectualPropertyExchangeOperatingSessionExchangeActionRequest getCaptureandClassificationExchangeActionRequest() {
    return captureandClassificationExchangeActionRequest;
  }

  public void setCaptureandClassificationExchangeActionRequest(CRIntellectualPropertyExchangeOperatingSessionExchangeInputModelIntellectualPropertyExchangeOperatingSessionExchangeActionRequest captureandClassificationExchangeActionRequest) {
    this.captureandClassificationExchangeActionRequest = captureandClassificationExchangeActionRequest;
  }
