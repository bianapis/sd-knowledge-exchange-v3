...
/**
 * CRIntellectualPropertyExchangeOperatingSessionControlOutputModel
 */
public class CRIntellectualPropertyExchangeOperatingSessionControlOutputModel   {
  ...
  private String intellectualPropertyExchangeOperatingSessionControlActionTaskReference = null;

  private Object intellectualPropertyExchangeOperatingSessionControlActionTaskRecord = null;

  private String intellectualPropertyExchangeOperatingSessionControlActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Intellectual Property Exchange Operating Session instance control processing service call 
   * @return intellectualPropertyExchangeOperatingSessionControlActionTaskReference
  **/

  public String getIntellectualPropertyExchangeOperatingSessionControlActionTaskReference() {
    return intellectualPropertyExchangeOperatingSessionControlActionTaskReference;
  }

  public void setIntellectualPropertyExchangeOperatingSessionControlActionTaskReference(String intellectualPropertyExchangeOperatingSessionControlActionTaskReference) {
    this.intellectualPropertyExchangeOperatingSessionControlActionTaskReference = intellectualPropertyExchangeOperatingSessionControlActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The processing control service call consolidated processing record 
   * @return intellectualPropertyExchangeOperatingSessionControlActionTaskRecord
  **/

  public Object getIntellectualPropertyExchangeOperatingSessionControlActionTaskRecord() {
    return intellectualPropertyExchangeOperatingSessionControlActionTaskRecord;
  }

  public void setIntellectualPropertyExchangeOperatingSessionControlActionTaskRecord(Object intellectualPropertyExchangeOperatingSessionControlActionTaskRecord) {
    this.intellectualPropertyExchangeOperatingSessionControlActionTaskRecord = intellectualPropertyExchangeOperatingSessionControlActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the control action service response 
   * @return intellectualPropertyExchangeOperatingSessionControlActionResponse
  **/

  public String getIntellectualPropertyExchangeOperatingSessionControlActionResponse() {
    return intellectualPropertyExchangeOperatingSessionControlActionResponse;
  }

  public void setIntellectualPropertyExchangeOperatingSessionControlActionResponse(String intellectualPropertyExchangeOperatingSessionControlActionResponse) {
    this.intellectualPropertyExchangeOperatingSessionControlActionResponse = intellectualPropertyExchangeOperatingSessionControlActionResponse;
  }
